...
import { ArrowRight, ChefHat, Flame, Shield, ShieldCheck, Utensils, CheckCircle2, Clock3, MapPin } from 'lucide-react'
...
export function ChefVerificationBanner() {
  const containerVariants = {
    hidden: { opacity: 0, y: 28, scale: 0.97 },
    show: {
      opacity: 1,
  ...
  return (
    <Motion.section
      ...
      viewport={{ once: true, amount: 0.2 }}
    >
      <Motion.div className="relative mx-auto w-full max-w-6xl cursor-default overflow-hidden rounded-[36px] shadow-[0_18px_36px_rgba(15,23,42,0.16)] transition-shadow duration-300 hover:shadow-[0_28px_58px_rgba(15,23,42,0.24)]">
        <div className="absolute inset-0 bg-[linear-gradient(118deg,#ea6c0a_0%,var(--theme-accent)_38%,#fb923c_65%,#fdba74_100%)]" />
        ...
        <div className="relative z-10 grid items-center px-6 py-8 sm:px-10 sm:py-10 lg:grid-cols-[1.2fr_0.8fr] lg:px-12">
          <div className="flex max-w-lg flex-col items-start">
            ...
            <Motion.h2
              ...
              className="mt-4 text-[26px] font-bold leading-[1.2] tracking-tight text-white sm:text-[34px]"
            >
              Wait until your profile
              <br />
              <span className="text-white">is verified by admin</span>
            </Motion.h2>
            ...
            <Motion.p
              ...
              className="mt-3.5 max-w-md text-[14px] leading-[1.75] text-white/84"
            >
              Your chef profile is under review. Once the admin verifies your details, your account will be activated and ready to take orders.
            </Motion.p>
            ...
            <Motion.div
              ...
              className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-3"
            >
              <FeaturePill icon={ShieldCheck} title="Profile submitted" subtitle="Details received safely" />
              <FeaturePill icon={Clock3} title="Under review" subtitle="Admin verification pending" />
              <FeaturePill icon={CheckCircle2} title="Go live soon" subtitle="Visible after approval" />
            </Motion.div>

            <Motion.div
              variants={itemVariants}
              className="mt-6 inline-flex items-center gap-2.5 rounded-2xl border border-white/25 bg-white/14 px-4 py-3 text-sm font-medium text-white/95 backdrop-blur-sm"
            >
              <Clock3 className="h-4 w-4" />
              Please wait until your profile is verified by the admin.
            </Motion.div>
          </div>
          ...
          <div className="relative mt-10 flex h-[280px] items-center justify-center lg:mt-0">
            ...
            >
              ...
              <p className="text-[10px] font-semibold text-white/90">Verification</p>
            </FloatCard>
...
export function ChefVerifiedBanner() {
  const containerVariants = {
    hidden: { opacity: 0, y: 28, scale: 0.97 },
    show: {
      opacity: 1,
  ...
  return (
    ...
    >
      <Motion.div className="relative mx-auto w-full max-w-6xl cursor-default overflow-hidden rounded-[36px] shadow-[0_18px_36px_rgba(15,23,42,0.16)] transition-shadow duration-300 hover:shadow-[0_28px_58px_rgba(15,23,42,0.24)]">
        <div className="absolute inset-0 bg-[linear-gradient(118deg,#0f766e_0%,#10b981_36%,#34d399_80%)]" />
        ...
        <Orb className="left-[-80px] top-[-60px] h-[260px] w-[260px] bg-white/10 blur-3xl" />
        <Orb className="bottom-[-60px] right-[15%] h-[200px] w-[200px] bg-[#065f46]/25 blur-2xl" />
        <Motion.div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_70%_50%,rgba(255,255,255,0.13),transparent_60%)]"
          animate={{ opacity: [0.8, 1, 0.8] }}
          transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
        ...
        <div className="pointer-events-none absolute left-[55%] top-0 h-full w-px rotate-[18deg] bg-emerald-100/18" />
        <div className="pointer-events-none absolute left-[58%] top-0 h-full w-[2px] rotate-[18deg] bg-white/12" />
        ...
        <div className="relative z-10 grid items-center px-6 py-8 sm:px-10 sm:py-10 lg:grid-cols-[1.2fr_0.8fr] lg:px-12">
          <div className="flex max-w-lg flex-col items-start">
            ...
            >
              ...
              <br />
              <span className="text-white">add your menu and go live</span>
            </Motion.h2>
            ...
            <Motion.p
              ...
              className="mt-3.5 max-w-md text-[14px] leading-[1.75] text-white/84"
            >
              Your chef profile has been approved. Add your menu items, pricing, and availability so customers can start ordering from you.
            </Motion.p>
            ...
            <Motion.div
              ...
              className="mt-5 grid grid-cols-1 gap-2 sm:grid-cols-3"
            >
              <FeaturePill icon={ShieldCheck} title="Verified chef" subtitle="Your profile is approved" />
              <FeaturePill icon={Utensils} title="Menu ready" subtitle="Add dishes and pricing" />
              <FeaturePill icon={MapPin} title="Go live" subtitle="Start serving nearby orders" />
            </Motion.div>

            <Motion.div variants={itemVariants} className="mt-6 flex flex-wrap items-center gap-3">
              <Link
                to="/chef/menu"
                className="group inline-flex items-center gap-2.5 rounded-2xl bg-white px-6 py-3.5 text-sm font-medium text-[#0f766e] shadow-[0_16px_36px_rgba(15,23,42,0.22)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(15,23,42,0.28)]"
              >
                Add Menu
                <span className="relative inline-flex h-4 w-4 overflow-hidden">
                  <ArrowRight className="absolute inset-0 h-4 w-4 transition duration-1000 group-hover:translate-x-[170%] group-hover:opacity-0" />
          ...
          <div className="relative mt-10 flex h-[280px] items-center justify-center lg:mt-0">
            ...
            >
              ...
              <p className="text-[10px] font-semibold text-white/90">Menu Setup</p>
            </FloatCard>
