...
function Navbar() {
  return (
    <header className="fixed inset-x-0 top-0 z-50 w-full bg-white/95 shadow-sm backdrop-blur-md">
      <div className="mx-auto flex h-16 w-auto items-center justify-between px-35">
        ...
        <div className="flex items-center gap-2">
          <button className="hidden cursor-pointer items-center gap-2 rounded-full border border-[#e2e8f0] bg-white px-3 py-2 text-xs font-semibold text-[#0f172a] transition hover:border-[#f97316] hover:text-[#f97316] md:inline-flex">
